...
function FuseShortcuts(props) {
	...
	function handleBack(event) {
		...
		if(from === 'patientlookup') {
			FromURL = `/patient/lookuplist/pid/${routeParams.id || routeParams.patient_id}/txt_patient_lname//txt_patient_fname//txt_patient_id//dob_mon//dob_dat//dob_yer//txt_phone//`;
