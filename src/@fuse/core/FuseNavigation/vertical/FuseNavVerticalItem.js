...
function FuseNavVerticalItem(props) {
	...
	const permission = useSelector(({auth}) => auth.permission);
	...
	const hasPermission = useMemo(() => FuseUtils.hasPermission(item.auth, userRole, permission, item), [item.auth, userRole]);
