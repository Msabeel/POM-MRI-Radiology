...
const SingleAuditDetailTable = ({ data }) => {
            ...
            <div className="flex flex-col min-h-full sm:border-1 overflow-hidden my-12">
                ...
                <div className="ag-theme-alpine ag-grid-custom" style={{ height: '120%', width: '100%', lineHeight: '30px' }}>
                    <AgGridReact className={classes.lookup} rowData={data} enableBrowserTooltips={true} tooltipShowDelay={0} pagination={true} paginationPageSize="15" rowHeight={38}>
                        ...
                        <AgGridColumn width={550} sortable={true} tooltipField="status" field="status" headerName="Status"></AgGridColumn>
                        <AgGridColumn width={300} sortable={true} tooltipField="curr_date_time" field="curr_date_time" headerName="Date of Action"></AgGridColumn>
                        <AgGridColumn width={200} sortable={true} tooltipField="displayname" field="displayname" headerName="User"></AgGridColumn>
                        <AgGridColumn width={120} sortable={true} tooltipField="scheduling_date" field="scheduling_date" headerName="Scheduled Date"></AgGridColumn>
...
SingleAuditDetailTable.propTypes = {
    data: PropTypes.array.isRequired,
    onRowClick: PropTypes.func,
    onStarClick: PropTypes.func
};

export default SingleAuditDetailTable;
