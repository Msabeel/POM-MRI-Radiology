  ...
  render() {
    ...
    return (
      <div className={baseClasses}>
        ...
        <h3 className={classNames} dangerouslySetInnerHTML={{ __html: myxss.process(this.props.data.question) }} />
      </div>
    );
  }
}
...
class CompanyLogo extends React.Component {
  render() {
    ...
    return (
      <div className={baseClasses}>
        <ComponentHeader {...this.props} />
        <img className="logo-icon " src={IndexSettings.index_logo} alt="logo" />
      </div>
    );
  }
}
...
class Header extends React.Component {
  render() {
    ...
    return (
      <div className={baseClasses}>
        <ComponentHeader {...this.props} />
        <h3 className={classNames} dangerouslySetInnerHTML={{ __html: this.props.data.question }} />
      </div>
    );
  }
}
...
class Paragraph extends React.Component {
  render() {
    ...
    return (
      <div className={baseClasses}>
        <ComponentHeader {...this.props} />
        <p className={classNames} dangerouslySetInnerHTML={{ __html: myxss.process(this.props.data.question) }} />
      </div>
    );
  }
}
...
class Label extends React.Component {
  render() {
    ...
    return (
      <div className={baseClasses}>
        <ComponentHeader {...this.props} />
        <label className={classNames} dangerouslySetInnerHTML={{ __html: myxss.process(this.props.data.question) }} />
      </div>
    );
  }
}
      ...
      <div className={baseClasses}>
        ...
        <div className="form-group">
          ...
          {this.props.data.options.map((option) => {
            ...
            const props = {};
            props.name = `option_${option.id}`;

            props.type = 'checkbox';
            props.value = option.value;
            if (self.props.mutable) {
              props.defaultChecked = self.props.defaultValue !== undefined && self.props.defaultValue.indexOf(option.id) > -1;
            }
            if (this.props.read_only) {
              props.disabled = 'disabled';
            }
              ...
              <div className={classNames} key={this_key}>
                <input id={"fid_" + this_key} className="custom-control-input" ref={c => {
                  if (c && self.props.mutable) {
                    self.options[`child_ref_${option.id}`] = c;
                  }
                }} {...props} />
                <label className="custom-control-label" htmlFor={"fid_" + this_key}>{option.option}</label>
              </div>
            );
          })}
        </div>
          ...
          {this.props.data.options.map((option) => {
            ...
            if (self.props.mutable) {
              props.defaultChecked = (self.props.defaultValue !== undefined &&
                (self.props.defaultValue.indexOf(option.id) > -1 || self.props.defaultValue.indexOf(option.value) > -1));
            }
            if (this.props.read_only) {
              props.disabled = 'disabled';
            }
...
FormElements.CompanyLogo = CompanyLogo;
FormElements.Tab = Tab;
