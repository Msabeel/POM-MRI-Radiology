...
import { TwoColumnRow, ThreeColumnRow, FourColumnRow, GroupRow } from './multi-column';
import CustomElement from './form-elements/custom-element';

const {
  Tab, CompanyLogo, Header, Paragraph, Label, LineBreak, TextInput, NumberInput, TextArea, Dropdown, Checkboxes,
  DatePicker, TimePicker, RadioButtons, Image, Rating, Tags, Signature, HyperLink, Download, Camera, Range,
} = BaseFormElements;

const FormElements = {};

FormElements.CompanyLogo = SortableElement(CompanyLogo);
FormElements.Tab = SortableElement(Tab);
...
FormElements.GroupRow = SortableElement(GroupRow);
