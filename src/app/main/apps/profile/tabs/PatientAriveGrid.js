...
export const PatientAriveGrid = ({
    ...
    const date = new moment().format('YYYY-MM-DD'); //2021-10-13
    //const [row] = useState();
    ...
    if(placeHolder==='arive')
    {
        filteredDate= data.filter(exam => exam.scheduling_date == date);
    }
