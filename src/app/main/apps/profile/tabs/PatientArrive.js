...
import { PatientAriveGrid } from './PatientAriveGrid';
import FuseScrollbars from '@fuse/core/FuseScrollbars';
import CircularStatic from 'app/fuse-layouts/shared-components/loader';
import { getAlertsByPid } from '../store/ProfileSlice'
import { getTasksByExam } from '../store/ProfileSlice'
					...
					<DialogContent>
						...
						<div style={{ marginBottom: 20, marginTop: 20 }}>
							<Typography
								...
								variant="h5" 
							>
								Confirm this is the patient you wish to arrive :  {props.name}
							</Typography>
						</div>
