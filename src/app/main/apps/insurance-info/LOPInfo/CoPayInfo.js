...
function LOPCoPayInfo(props) {
    ...
    const initDialog = useCallback(async () => {
		if (lopCoPayInfoDialog.data) {
			setForm({ ...lopCoPayInfoDialog.data });
		}
	}, [lopCoPayInfoDialog.data, setForm]);

	useEffect(() => {
		/**
		 * After Dialog Open
		 */
		if (lopCoPayInfoDialog.props.open) {
			initDialog();
		}
	}, [lopCoPayInfoDialog.props.open, initDialog]);

	function closeComposeDialog() {
		dispatch(closeLOPCoPayDialog({ ...form, isFormValid, formName: 'LOPCoPay' }));
	}
