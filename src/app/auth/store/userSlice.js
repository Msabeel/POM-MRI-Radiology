...
export const setUserData = user => async (dispatch, getState) => {
	...
	if (user.data.settings !== undefined) {  // check if user setting is not undefined then only store
		localStorage.setItem('user_setting', JSON.stringify(user.data.settings))
	}
